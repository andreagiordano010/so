...
int main() {
    ...
    if(ret < 0) {
        perror("Errore inizializione semaforo MUTEXL");
        exit(1);
    }
    ...
    if(ret < 0) {
        perror("Errore inizializione semaforo MUTEXS");
        exit(1);
    }
    ...
    if(ret < 0) {
        perror("Errore inizializione semaforo MUTEX");
        exit(1);
    }
    ...
    if(ret < 0) {
        perror("Errore inizializione semaforo SYNCH");
        exit(1);
    }
